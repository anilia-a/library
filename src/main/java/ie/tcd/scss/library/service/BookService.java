...
public class BookService {
    ...
    public Book createBook(String title, String authors, Integer publicationYear, Integer price, String isbn, String keywords,
                           String description, String librarySectionCode){
        ...
        return bookRepository.save(new Book(title, authors, publicationYear, price, isbn, keywords, description, librarySection));
    }
